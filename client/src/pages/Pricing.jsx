...
function Pricing() {
    ...
    const plans = [
...

        {
            ...
            price: "₹499",
            credits: 500,
            description: "For freelancers, students, and creators",
            features: [
                "Everything in Free",
                "Faster generation",
                "Edit & regenerate",
...

        {
            ...
            price: "₹1499",
            credits: 1000,
            description: "Built for agencies and businesses",
            features: [
                "Everything in Pro",
                "Unlimited projects",
                "Team collaboration",
            ...
            <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                {plans.map((p, i) => (
                    <motion.div
                        ...
                        {p.popular && (
                            <span className="absolute top-5 right-3 px-3 py-1 text-xs rounded-full bg-indigo-500">
                                Most popular
                            </span>
                        )}
